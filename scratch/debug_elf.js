...
console.log('relocations:', parsed.relocations);
console.log('gotEntries:', parsed.gotEntries);
console.log('pltEntries:', parsed.pltEntries);
console.log('sectionHeaders:', parsed.sectionHeaders.map(s => ({ name: s.name, type: s.type })));
console.log('symbols:', parsed.symbols);
